const AlcoholFree = {
    ...
    <div class="stockDiv">
      ...
      <i :style="displayMinus" v-on:click="zoomOut" class="fas fa-search-minus"></i>
          ...
          <div class="col-md-2 stockRow" v-bind:id="g.name" v-for="(g, index) in sortedList" :key="goods._id">
            <img class="bottle animated" src="static/img/bottle/ginHendrick's.png" alt="ginMare">
            <div>
              {{g.stock}}
            </div>
          </div>
